...
//                    AppUtils.installApp(saveFileName, "zhy.com.disabuse.provider");
    ...
    private void showDownloadDialog(){
        ...
        //对话框沉底
//        WindowManager.LayoutParams params = downLoadingDialog.getWindow().getAttributes();
//        params.gravity = Gravity.BOTTOM;
//        downLoadingDialog.getWindow().setAttributes(params);
    }
