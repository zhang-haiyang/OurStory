package test.com.video.activity;
...
import test.com.video.customView.VideoPlayerLayout;
import test.com.video.listener.VideoPlayerListener;

/**
 * 视屏播放页
 * Created by hww on 2018/1/17.
 */
@Route(path = "/video/File")
